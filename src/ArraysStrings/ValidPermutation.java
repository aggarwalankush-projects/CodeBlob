...
public class ValidPermutation {
    ...
    public static void main(String[] args) {
        System.out.println(validPermutation1("ball","labl"));
        System.out.println(validPermutation1("racket","traced"));
        System.out.println(validPermutation2("ball", "labl"));
        System.out.println(validPermutation2("racket", "traced"));
    }
