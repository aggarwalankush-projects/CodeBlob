...
public class ReverseString {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ball -> " + reverse1("ball"));
        System.out.println("racket -> " + reverse1("racket"));
        System.out.println("ball -> " + reverse2("ball"));
        System.out.println("racket -> " + reverse2("racket"));
    }
